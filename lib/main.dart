...
void main() async {
  ...
  // Sleep Sounds: registers the background audio/lock-screen-controls
  // service. Must run before any AudioPlayer using a MediaItem tag is
  // created, so this happens once here rather than inside the feature
  // screen itself.
  await JustAudioBackground.init(
    androidNotificationChannelId: 'com.gracelog.app.sleep_sounds',
    androidNotificationChannelName: 'GraceLog Sleep Sounds',
